...
const Template = args => React.createElement(TextInput, Object.assign({}, args));
...
export const TextFieldWithLabel = () => {
    ...
    return (React.createElement(Box, { gap: 2, justifyContent: "flex-start" },
        React.createElement(TextInput, { type: "text", placeholder: "i.e) david", label: "First Name", onChange: () => {
                setState(state + 1);
            } }),
        React.createElement(TextInput, { type: "text", placeholder: "i.e) kim", label: "Last Name", onChange: () => {
                setState(state + 1);
            } })));
};
...
export const TextFieldWithEverything = () => {
    ...
    return (React.createElement(Box, { gap: 4, direction: "column", alignItems: "flex-start" },
        React.createElement(TextInput, { type: "text", placeholder: "24", label: "Age", onChange: handleChange, error: error ? errorMessage : null, helpText: "Type a special character to get error" }),
        React.createElement(Box, { gap: 2 },
            React.createElement(TextInput, { type: "text", placeholder: "i.e) david", label: "First Name", helpText: "Your name" }),
            React.createElement(TextInput, { type: "text", placeholder: "i.e) kim", label: "Last Name", helpText: "Your name" }))));
};
